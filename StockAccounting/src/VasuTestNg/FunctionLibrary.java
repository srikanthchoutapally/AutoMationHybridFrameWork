...
//startBrowser
	public static WebDriver startBrowser(WebDriver driver) throws Throwable
	{
		...
		{
			System.setProperty("webdriver.gecko.driver", "D:\\Vasu8AM\\StockAccounting\\CommonJarFiles\\geckodriver.exe");
			driver=new FirefoxDriver();
		}else
			if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome"))
			{
				System.setProperty("webdriver.chrome.driver", "E:\\Live project\\AutomationTesting\\StockAccounting\\CommonJarFiles\\chromedriver.exe");
	...
	//scroll down page
			...
			public static void captureData(WebDriver driver,String locatorType,String locatorValue) throws Throwable
			{
				...
				FileWriter fw=new FileWriter("D:\\Vasu8AM\\StockAccounting\\CaptureData\\Data.txt");
	...
	//SupplierCreation Table Validation
		...
		public static void tableValidation(WebDriver driver,String column) throws Throwable
		{
			...
			FileReader fr=new FileReader("D:\\Vasu8AM\\StockAccounting\\CaptureData\\Data.txt");

...
public class ExcelFileUtil
{
	...
	{
		FileInputStream fis=new FileInputStream("E:\\Live project\\AutomationTesting\\StockAccounting\\TestInputs\\InputSheet.xlsx");
	...
	//Wtring data into excel pass or fail and not executed  //states//
	...
	public void setData(String sheetname,int row,int column,String status) throws Throwable
	{
		...
		FileOutputStream fos=new FileOutputStream("E:\\Live project\\AutomationTesting\\StockAccounting\\TestOutput\\OutputSheet.xlsx");
		wb.write(fos);
		fos.close();
	}
